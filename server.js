  ...
  const evMarket =
    market.referenceEvPct == null
      ...
      : `${
          ...
          market.referenceEvPct.toFixed(1)
        }%`;
        ...
        `<span>Mercado: <b>` +
          `${
            market.referenceOdds
              ? market.referenceOdds.toFixed(2)
              : '-'
          }` +
        `</b></span>` +

        `<span>EV mercado: <b>${evMarket}</b></span>` +

        `<span>Casas: <b>${market.bookmakerCount}</b></span>` +
